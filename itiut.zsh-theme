...
ZSH_THEME_GIT_PROMPT_AHEAD="%{$fg_bold[magenta]%} ⬆ %{$fg_no_bold[magenta]%}$(git_commits_ahead)"
ZSH_THEME_GIT_PROMPT_BEHIND="%{$fg_bold[red]%} ⬇ %{$fg_no_bold[red]%}$(git_commits_behind)"
